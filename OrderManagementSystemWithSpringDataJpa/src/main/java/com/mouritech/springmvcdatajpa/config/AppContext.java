package com.mouritech.springmvcdatajpa.config;
...
@ComponentScan({
	"com.mouritech.springmvcdatajpa"
})
@EnableJpaRepositories(basePackages = "com.mouritech.springmvcdatajpa.repository")
public class AppContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] {
				"com.mouritech.springmvcdatajpa.entity"
		});
